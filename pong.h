...
public:
    ...
    void Draw() {
        ...
        //Score
        Matrix scoreTransforms[20];
        Color scoreColors[20];
        int scoreInstanceIdx = 0;

        //Player 1
        rlPushMatrix();
        rlTranslatef(-1.6f, 0.5f, -0.5f);
            scoreColors[scoreInstanceIdx] = Color{255,255,255,16 + player2Score};
            scoreTransforms[scoreInstanceIdx++] = rlGetMatrixTransform();
        rlTranslatef(0, 0, -0.5f);
            scoreColors[scoreInstanceIdx] = Color{255,255,255,16 + player2Score};
            scoreTransforms[scoreInstanceIdx++] = rlGetMatrixTransform();
        rlTranslatef(0, 0, -0.5f);
        ...
        rlPushMatrix();
        rlTranslatef(1.6f, -0.5f, -0.5f);
            scoreColors[scoreInstanceIdx] = Color{255,255,255,16 + player1Score};
            scoreTransforms[scoreInstanceIdx++] = rlGetMatrixTransform();
        rlTranslatef(0, 0, -0.5f);
            scoreColors[scoreInstanceIdx] = Color{255,255,255,16 + player1Score};
            scoreTransforms[scoreInstanceIdx++] = rlGetMatrixTransform();
        ...
        DrawMeshInstancedC(quadMesh, textMaterial, scoreTransforms, scoreColors, scoreInstanceIdx);
    }
